...
/**
 * Coil Fetcher that handles `gdrive://<fileId>` URIs.
 * Downloads the file to local cache via [GoogleDriveImageSource], then serves it from disk.
 */
class DriveCoilFetcher(
    ...
    override suspend fun fetch(): FetchResult? = withContext(Dispatchers.IO) {
        ...
        // We need the filename for caching. Use the fileId as a fallback name.
