    ...
    try:
        ...
        try:
            for name in os.listdir(parent):
                ...
                # Check for same stem but different extension
                if name.startswith(stem_dot) and name.rfind('.') == stem_len:
                    is_match = True
                # Check for Lightroom edits
                elif name_lower.startswith(edit_prefix):
                    is_match = True
