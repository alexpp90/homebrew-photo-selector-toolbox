...
from photo_selector_toolbox.exif.readers.base import ExifReader
from photo_selector_toolbox.core.utils import get_exiftool_path
...
class ExifToolReader(ExifReader):
    ...
    def can_handle(self, path: Path) -> bool:
        ...
        from photo_selector_toolbox.exif.reader import FORCE_EXIFTOOL_EXTENSIONS
