...
def test_show_scan_dialog_validation():
    ...
    with patch("photo_selector_toolbox.gui.sharpness_tool.tk.Toplevel") as mock_toplevel, \
         ...
         patch("photo_selector_toolbox.gui.sharpness_tool.SharpnessTool.setup_focus_ui"), \
         patch("photo_selector_toolbox.gui.sharpness_tool.SharpnessTool.bind_all"), \
         patch("photo_selector_toolbox.gui.sharpness_tool.messagebox.showerror") as mock_showerror, \
         patch("photo_selector_toolbox.gui.sharpness_tool.Path.exists", return_value=False):
...
def test_show_scan_dialog_creation():
    ...
    with patch("photo_selector_toolbox.gui.sharpness_tool.tk.Toplevel") as mock_toplevel, \
         ...
         patch("photo_selector_toolbox.gui.sharpness_tool.ttk.Checkbutton"), \
         patch("photo_selector_toolbox.gui.sharpness_tool.ttk.Combobox"), \
