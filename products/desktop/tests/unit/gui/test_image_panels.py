...
def mock_gui_deps():
    with (
        patch("photo_selector_toolbox.gui.image_panels.ttk.LabelFrame") as MockLabelFrame,
        patch("photo_selector_toolbox.gui.image_panels.ttk.Frame") as MockFrame,
        patch("photo_selector_toolbox.gui.image_panels.ttk.Label") as MockLabel,
        patch("photo_selector_toolbox.gui.image_panels.ImageTk.PhotoImage") as MockPhotoImage,
        patch("photo_selector_toolbox.gui.image_panels.create_placeholder_image") as MockCreatePlaceholder,
        patch("photo_selector_toolbox.gui.image_panels.load_image_preview") as MockLoadImagePreview,
    ):
        yield {
