...
@patch("photo_selector_toolbox.core.sharpness.get_image_data")
...
@patch("photo_selector_toolbox.core.sharpness.get_image_data")
@patch("photo_selector_toolbox.core.sharpness.cv2")
...
def test_tool_registry():
    ...
    with patch("photo_selector_toolbox.core.sharpness.calculate_highlight_clipping") as mock_hl:
    ...
    with patch("photo_selector_toolbox.core.sharpness.calculate_shadow_clipping") as mock_sd:
