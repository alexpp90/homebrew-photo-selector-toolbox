...
from photo_selector_toolbox.core.config import (
    load_config,
    save_config,
    add_recent_folder,
    get_recent_folders,
...
def mock_config_paths(tmp_path):
    ...
    with (
        patch("photo_selector_toolbox.core.config.CONFIG_DIR", config_dir),
        patch("photo_selector_toolbox.core.config.CONFIG_FILE", config_file),
    ):
...
@patch("photo_selector_toolbox.core.config.save_config")
