...
from photo_selector_toolbox.core.cache import ScoreCache, set_default_db_path
...
def test_controller_uses_cache(tmp_path):
    ...
    try:
        ...
        with (
            patch("photo_selector_toolbox.gui.controllers.get_exif_data") as mock_exif,
            patch("photo_selector_toolbox.core.sharpness.calculate_all_scores") as mock_calc,
            patch("photo_selector_toolbox.gui.controllers.ToolRegistry.get") as mock_tool_registry,
        ):
...
def test_score_cache_error_handling(tmp_path):
    ...
    with patch("sqlite3.connect") as mock_connect:
        ...
        with patch("photo_selector_toolbox.core.cache.logger.warning") as mock_warning:
        ...
        with patch("photo_selector_toolbox.core.cache.logger.error") as mock_error:
