...
def _open_file_for_user(filepath: Path):
    ...
    try:
        ...
        # Previously, xdg-open/open/os.startfile were used with raw paths, which posed a
        # command injection vulnerability. This is mitigated by restricting files to '.png'
        # and using the webbrowser module with 'file://' URIs derived from absolute paths.
