...
class SharpnessTool(ttk.Frame, ImagePanelsMixin):
    ...
    def _setup_focus_right_panel(self):
        ...
        # Cache buttons for efficient state updates
        self._nav_prev_btns = [self.prev_btn, self.focus_prev_btn]
        self._nav_next_btns = [self.next_btn, self.focus_next_btn]
        self._nav_action_btns = [
            self.del_btn,
            self.focus_del_btn,
            self.move_btn,
            self.focus_move_btn,
        ...
        self._all_nav_btns = (
            self._nav_prev_btns + self._nav_next_btns + self._nav_action_btns
        )
    ...
    def update_button_states(self):
        ...
        for btn in self._nav_prev_btns:
            try:
        ...
        for btn in self._nav_next_btns:
            try:
        ...
        # Action buttons
        for btn in self._nav_action_btns:
            try:
                btn.state(["!disabled"])
            except Exception:
                pass
